      ...
      >
        ...
        <div className="space-y-4">
          <h1 className="text-gray-900">
            You’ve heard the buzz about <span class="bg-gradient-to-br from-purple-500 to-blue-500 text-transparent bg-clip-text">Web3</span> — now see what it really means for you.
          </h1>
